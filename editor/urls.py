...
urlpatterns = [
    ...
    path('route/<int:route_id>/remove_point/<int:point_id>/', views.remove_point, name='remove_point'),
    ...
    path('route/<int:route_id>/change_points_order_ajax/', views.change_points_order_ajax, name='change_points_order_ajax'),
